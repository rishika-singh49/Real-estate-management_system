	    	        ...
	    	        <%
	    	        		
	    	        		{
									...
									)
								{
									...
									query = "select house_id,city,street_name,apartment_number,sale_price,rent_price,sale_status,rent_status,number_of_bedrooms,specificatons from house where seller_user_name = ?";
