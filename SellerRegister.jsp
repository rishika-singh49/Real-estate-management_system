...
<body>  
	  ...
	  <a class="navbar-brand" href="index.jsp"><i class="glyphicon glyphicon-home"></i>  Real-Estate</a>
		...
		<br><br>
		<br><br>
		<div class="sellerRegister-big-image">
	    	...
	    	<div class="d-flex justify-content-center align-items-center ">
	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-4">
						...
						<p>	User Name  : </p> <input autocomplete="off" class="form-control" type="text" name="sellerUserName" placeholder="user name.." required="">
							<br>
						<p>	Name  :</p> <input autocomplete="off" class="form-control" type="text" name="sellerName" placeholder="your name.." required="">
							<br>
						<p>	Contact Number  :</p> <input autocomplete="off" class="form-control" type="text" name="sellerContactNumber" pattern="[0-9]{10}" placeholder="10 digit phone number.." required="" maxlength="10">
							<br>

						<p>	Password  :</p> <input autocomplete="off" class="form-control" type="password" name="sellerPassword" pattern=".{8,}"  placeholder="eight or more characters password.." required="">
							<br>
