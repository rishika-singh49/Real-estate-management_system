	...
	<%
         String url = "jdbc:mysql://sql5.freesqldatabase.com:3306/sql5436331";
				...
				)
			{
               ...
               ResultSet rset = stmt.executeQuery("select agent_id,agent_name,house_id,city,street_name,sale_price,no_bedrooms,specificatons,purchase_date from agents natural join house natural join purchase where sale_status=\'Y\' order by agent_id");
