	    	...
	    	<div class="d-flex justify-content-center align-items-center ">
	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-4">
						...
						<p>	User Name : </p> <input autocomplete="off" class="form-control" type="text" name="sellerUserName" required="">
							<br><br>

							<p>Password  : <p> <input autocomplete="off" class="form-control" type="password" name="sellerPassword"   required="">
							<br><br>
