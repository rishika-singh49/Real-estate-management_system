	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-3">
	    				...
	    				<form action="ValidateUHS.jsp" >
							 ...
							 HouseId : 
							 <input type="number" name="houseId" class="form-control" required="" placeholder="HouseId...">
							 <br><br>
							 BuyerId :
							 <input type="number" name="buyerId" class="form-control" required="" placeholder="BuyerId..">
							 <br><br>
							 Type :
							<input type="radio" name="type" value="sale"  required=""> <span style="font-size:20px">sale</span>
